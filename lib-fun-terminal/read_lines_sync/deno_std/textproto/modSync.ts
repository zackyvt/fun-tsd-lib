// Based on https://raw.githubusercontent.com/denoland/deno/master/std/textproto/mod.ts
...
export class TextProtoReader {
   ...
   *	}
   */
  readMIMEHeader(): Headers | Deno.EOF {
    const m = new Headers();
  ...
  readLineSlice(): Uint8Array | Deno.EOF {
    // this.closeDot();
    let line: Uint8Array | undefined;
    while (true) {
